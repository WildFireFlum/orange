...
constexpr unsigned long long KEY_MASK = 0xffff0000ULL;
constexpr unsigned char FLAGS_BIT_OFFSET = 2;
constexpr unsigned char KEY_OFFSET = 32;
...
struct Chunk {
    ...
    bool rebalance(std::pair<uint64_t, V>* keyValPair);
