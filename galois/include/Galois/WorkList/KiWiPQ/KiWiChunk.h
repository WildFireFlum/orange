#ifndef __KIWI_CHUNK_H__
#define __KIWI_CHUNK_H__
...
template <typename K>
struct Chunk {
    Chunk(K* min_key, Chunk<K>* rebalance_parent);
...
template <typename K>
Chunk<K>::Chunk(K* min_key, Chunk<K> *rebalance_parent)
        : m_min_key(min_key),
